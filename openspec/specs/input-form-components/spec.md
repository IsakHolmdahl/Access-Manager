...
The Input and Form components provide form controls for user data entry. These components support text input, selection, checkbox/radio controls, and proper labeling with full accessibility compliance.
