...
The Navigation Shell components provide the structural layout and navigation system for the application. This includes the Shell, Header, Sidebar, Main content area, Mobile navigation, and user navigation components.
